@extends('layouts.app')
@section('page.title','Pagine')
@section('page.navbar')
    @if(request('filtered'))
        <li><a href="{{ URL::current() }}"><i class="fa fa-chevron-left fa-fw"></i> Lista Pagine</a></li>
    @endif
@endsection
@section('content')
<div class="container">
     ...
     <div style="margin-bottom: 20px;">
        ...
        <a href="{{ route('pages.create') }}" class="btn btn-primary btn-sm">Nuova Pagina</a>
    </div>
            ...
            <table class="table table-bordered table-striped table-condensed">
                ...
                <tr>
                    <td class="text-center success">
                        <a href="{{ route('pages.edit', $page->Id) }}"><i class="fa fa-fw fa-pencil"></i></a>
                    </td>
...
@section('bottom')
    ...
    <script>
        ...
        $('#elimina').on('show.bs.modal', function (event) {
            ...
            var modal = $(this)
            modal.find('form').attr('action','{{ route('pages.destroy',null) }}/'+id);
